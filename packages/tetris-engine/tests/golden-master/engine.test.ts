...
import type { GameEvent, Matrix, Piece, PieceType } from "../../src/types.js";
...
class PieceBag {
  ...
  private refill(): void {
    const allPieces: PieceType[] = ["I", "J", "L", "O", "S", "T", "Z"];
...
describe("Game Engine Golden Master Tests", () => {
  ...
  it("should handle line clearing consistently", () => {
    ...
    const lineClears: Array<{ frame: number; lines: number; score: number }> = [];
